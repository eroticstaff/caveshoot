...
void GameObject::drawOrigin(sf::RenderTarget &target,
...
void GameObject::drawBoundingBox(sf::RenderTarget &target,
                                 const sf::RenderStates &states) const {
  sf::RectangleShape rect;
  rect.setSize(sf::Vector2f(m_sprite.getLocalBounds().width,
